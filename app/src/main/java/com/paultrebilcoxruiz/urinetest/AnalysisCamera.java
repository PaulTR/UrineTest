...
public class AnalysisCamera {
    private static final String TAG = AnalysisCamera.class.getSimpleName();
    ...
    private AnalysisCamera() {
    }

    private static class InstanceHolder {
        private static AnalysisCamera mCamera = new AnalysisCamera();
    }

    public static AnalysisCamera getInstance() {
